...
if the task successfuly completed - you will see something like a "Copied to clipboard", and code looks like a:
...
> "NOTE:" You should to install jetbra package, from [original repo](https://github.com/novice88/jetbra)
